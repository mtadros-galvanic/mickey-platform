...
- currently provision `mickey-infra`, `mickey-erp`, `mickey-thud`, `mickey-scarthgap`, `mickey-brimstone`, `mickey-at4`, `mickey-tmp`, and `mickey-controller` from the committed prod inputs
